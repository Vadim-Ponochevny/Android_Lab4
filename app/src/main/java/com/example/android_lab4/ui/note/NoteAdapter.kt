...
class NoteAdapter @Inject constructor(
    ...
    inner class ViewHolder(private val binding: OneNoteBinding) : RecyclerView.ViewHolder (binding.root) {
        fun bind(item: Note) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = OneNoteBinding.inflate(LayoutInflater.from(parent.context), parent, false)
